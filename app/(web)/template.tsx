...
function Template({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div>
            <div id="banner" className='w-screen min-h-screen bg-gradient-to-t from-blue-600 via-blue-700 to-neutral-900 z-50 fixed top-0 left-0 flex justify-center items-center'>
