  ...
  return (
    <RoundedNav>
      <ul className="h-48 flex font-semibold text-xs lg:text-xl">
        <li className="py-2 flex-1 cursor-pointer gap-12 text-lg bg-gradient-to-t from-customRed dark:to-slate-900 hover:text-2xl transition-all duration-100 ease-linear">
        ...
        <li className="py-2 flex-1 cursor-pointer gap-12 text-lg bg-gradient-to-t from-customRed/80 dark:to-slate-900 hover:text-2xl transition-all duration-100 ease-linear">
        ...
        <li className="py-2 flex-1 cursor-pointer gap-12 text-lg bg-gradient-to-t from-customRed/70 dark:to-slate-900 hover:text-2xl transition-all duration-100 ease-linear">
        ...
        <li className="py-2 flex-1 cursor-pointer gap-12 text-lg bg-gradient-to-t from-customRed/60 dark:to-slate-900 hover:text-2xl transition-all duration-100 ease-linear">
